...
from src.labram_ft.data_processor.dataset import ShockDataset
import pickle
...
class MIRRORGAMELoader(torch.utils.data.Dataset):
...
class FORCEGAMELoader(torch.utils.data.Dataset):
    def __init__(self, root, files, sampling_rate=200):
        self.root = root
        self.files = files
        self.default_rate = 200
