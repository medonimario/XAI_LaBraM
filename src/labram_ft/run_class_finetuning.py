...
MIRRORGAME_DATASET_ROOT = os.path.join(MG_DATASET_PATH, "processed")
...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset(TUAB_DATASET_ROOT)
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset(TUEV_DATASET_ROOT)
...
def main(args, ds_init):
    ...
    if args.dataset == 'TUEV':
        project_name = "labram-finetune-tuev"
    elif args.dataset == 'TUAB':
        project_name = "labram-finetune-tuab"
    elif args.dataset == 'FORCEGAME':
        project_name = "labram-finetune-forcegame"
    elif args.dataset == 'FORCEGAME_GROUP':
        project_name = "labram-finetune-forcegame-group"
    elif args.dataset == 'FORCEGAME_FRIENDSHIP':
        project_name = "labram-finetune-forcegame-friendship"
    elif args.dataset == 'MIRRORGAME':
        project_name = "labram-finetune-mirrorgame"
    elif args.dataset == 'MIRRORGAME_INSTRUCTED':
        project_name = "labram-finetune-mirrorgame-instructed"
    elif args.dataset == 'MIRRORGAME_SOLO_SPONT':
        project_name = "labram-finetune-mirrorgame-solo-spont"
    elif args.dataset == 'CIRCLING':
        project_name = "labram-finetune-circling"
    else:
    ...
    if utils.is_main_process():
        wandb.init(
            ...
            name=f"bs{args.batch_size*args.update_freq}-lr{args.lr}-smooth{args.smoothing}" # A descriptive name for the run
        )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if utils.is_main_process():
            ...
            print(f"wandb logged at epoch {epoch}")
